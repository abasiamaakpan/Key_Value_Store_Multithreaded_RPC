...
public class GRPCClient7 {
     ...
     * Clientname
     */
    public static final String sendclientname="Client 7";
...
//                            syncKeyValueStoreStub4.deleteKeyValue(request);
        ...
        public static synchronized void shutdownServer(int servertoshutdown, int command){
            ...
            try {
               ...
               // System.out.println(responseserverremoved.getDroppedserverMap().entrySet());
                ...
                //Server has never been shutdown
                    ...
                    for (int i=0; i<5; i++){
                       ...
                       // if(unavailableserversWithoutDuplicates.contains(responseserverremoved.getPairsMap().containsValue(unavailableserversWithoutDuplicates.get(i)))){
